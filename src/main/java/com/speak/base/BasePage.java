...
public class BasePage {
	...
	public Properties initialize_properties(){
		...
		try {
			FileInputStream ip = new FileInputStream("/Users/senaakarca/Documents/workspace/TestNG_ISpeakBetter/" 
		+ "src/main/java/config/speak/config/config.properties");
			prop.load(ip);
		} catch (IOException e) {
			e.printStackTrace();
		}
